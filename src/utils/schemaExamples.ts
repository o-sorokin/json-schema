...
export const RealUserSchema = {
  "$schema": "http://json-schema.org/draft-07/schema#",
  "description": "Подсекция: продукты и сервисы V2 (секция продукты и сервисы)",
  "type": "object",
  "properties": {
    "analytics": {
      "$ref": "#/definitions/analyticsDef"
    },
    "id": {
      "description": "Идентификатор данных",
      "type": "string",
      "maxLength": 255,
      "const": "promoServicesV2Subsection"
    },
    "data": {
      "properties": {
        "compositionType": {
          "description": "ONE_TWO_IN_ROWS - чередование строк, первая строка одна кнопка, вторая строка две кнопки\n\nTWO_ONE_IN_ROWS  - чередование строк, первая строка две кнопки, вторая строка одна кнопка",
          "type": "string",
          "maxLength": 255,
          "enum": [
            "ONE_TWO_IN_ROWS",
        ...
        "expandButton": {
          "$ref": "#/definitions/expandButton"
        },
        "expandBottomSheetTopComponent": {
          "$ref": "#/definitions/expandBottomSheetTopComponent"
        },
        "components": {
          "type": "array",
          "description": "Массив компонентов",
          "items": {
  ...
  "definitions": {
    "analyticsDef": {
      "description": "Параметры для продуктовой аналитики",
      "type": "object",
      "properties": {
        "alias": {
          "description": "Псевдоним названия элемента для аналитики",
          "type": "string",
          "maxLength": 255
        },
        "sendOnDisplay": {
          "description": "Признак, что нужно отправлять аналитику при показе элемента",
          "type": "boolean"
        }
      },
      "required": [
    ...
    "expandButton": {
      "description": "Настройки кнопки \"Смотреть все\"",
      "type": "object",
      "properties": {
        "data": {
          "type": "object",
          ...
          "properties": {
            ...
            "expandBottomSheetTitle": {
              "type": "string",
              "description": "Заголовок для боттом шита",
              "maxLength": 255
            }
          },
          "additionalProperties": false,
    ...
    "expandBottomSheetTopComponent": {
      "type": "object",
      "description": "Компонент подсекции",
      "properties": {
        "id": {
        ...
        "type": {
          ...
          "type": "string",
          "maxLength": 255,
          "const": "CLIENT_CONSENT_COMPONENT"
        },
        "analytics": {
          "$ref": "#/definitions/analyticsDef"
        },
      ...
      "properties": {
        ...
        "data": {
          ...
          "properties": {
            ...
            "titleDescription": {
              "description": "Текст для озвучивания заголовка",
              "type": "string",
              "maxLength": 255
            },
            "subtitleDescription": {
              "description": "Текст для озвучивания подзаголовка",
              "type": "string",
              "maxLength": 255
            },
            "imageUrl": {
    ...
    "action": {
      ...
      "properties": {
        ...
        "data": {
          ...
          "patternProperties": {
            "^(?=.{1,256}$)[A-Za-z0-9_-]+$": {
              "description": "Свойство данных секции/подсекции",
              "anyOf": [
                {
                  "type": "string",
                  "maxLength": 512
